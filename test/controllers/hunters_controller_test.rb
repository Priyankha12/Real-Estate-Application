...
class HuntersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hunter" do
    assert_difference('Hunter.count') do
      post hunters_url, params: { hunter: { contact_method: @hunter.contact_method, email: @hunter.email, full_name: @hunter.full_name, password: @hunter.password, phone: @hunter.phone } }
    end
  ...
  test "should update hunter" do
    patch hunter_url(@hunter), params: { hunter: { contact_method: @hunter.contact_method, email: @hunter.email, full_name: @hunter.full_name, password: @hunter.password, phone: @hunter.phone } }
